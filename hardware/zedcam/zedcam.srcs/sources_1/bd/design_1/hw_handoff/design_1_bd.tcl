...
proc create_root_design { parentCell } {
  ...
  set reset_0 [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 reset_0 ]

  set standby_0 [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 standby_0 ]
  ...
  set block_cell_name CSI_RX_0
  if { [catch {set CSI_RX_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
  ...
  connect_bd_intf_net -intf_net axi_gpio_0_GPIO [get_bd_intf_ports reset_0] [get_bd_intf_pins axi_gpio_0/GPIO]
  connect_bd_intf_net -intf_net axi_gpio_1_GPIO [get_bd_intf_ports standby_0] [get_bd_intf_pins axi_gpio_1/GPIO]
