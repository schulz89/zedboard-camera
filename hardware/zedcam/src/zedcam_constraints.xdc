...
set_property PACKAGE_PIN W12 [get_ports {data_in_0[7]}]
set_property PACKAGE_PIN V12 [get_ports {data_in_0[6]}]
set_property PACKAGE_PIN AA9 [get_ports {data_in_0[5]}]
set_property PACKAGE_PIN AA8 [get_ports {data_in_0[4]}]
set_property PACKAGE_PIN Y10 [get_ports {data_in_0[3]}]
set_property PACKAGE_PIN AB9 [get_ports {data_in_0[2]}]
set_property PACKAGE_PIN AA11 [get_ports {data_in_0[1]}]
set_property PACKAGE_PIN AB10 [get_ports {data_in_0[0]}]
